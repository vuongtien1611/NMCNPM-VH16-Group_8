...
export async function createOrder(params = {}) {
    ...
    container.innerHTML = `
        ...
        <form id="orderForm">
            <div class="form">
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="amount" value="${initialValues.amount || ""}" placeholder="Nhập số lượng">
                    </div>
            ...
            <div class="form-footer">
                <button type="reset" class="btn btn-cancel">Hủy bỏ</button>
                <button type="submit" class="btn btn-save">${id ? "Cập nhật" : "Tạo đơn hàng"}</button>
            </div>
        </form>
    `;
        ...
        createForm({
            ...
            onSubmit: async (values) => {
                try {
                    ...
                    if (response) window.location.hash = "/orders";
                } catch (error) {
